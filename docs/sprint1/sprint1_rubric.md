...
## Tracking on Jira  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Majority of the subtasks and user stories missing a pull request
  ...
  Your Mark: 1 
  Feedback: Some pull requsts are not sdone by the person who completed the task
...
Your Mark: 2
Feedback: No pull requests found for SCAR-2, SCAR-26, SCAR-10
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 8 / 20
  Feedback: SCAR-2, SCAR-5, SCAR-10 started but not completed
